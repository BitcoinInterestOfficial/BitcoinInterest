...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 1547510400; // January 15th, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1579046400; // January 15th, 2020

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 1547510400; // January 15th, 2019.
