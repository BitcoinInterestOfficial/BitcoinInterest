...
public:
    CMainParams() {
            ...
            consensus.BCIHeight = 505083; // Around 01/22/2018 12:00 UTC
            consensus.BCIPremineWindow = 8000;
            consensus.BCIPremineEnforceWhitelist = true;
            consensus.BitcoinPostforkBlock = uint256S("00000000000000000035e9ac079854b0b30847ffb7fda0ef1a4928b13615db3b");
            consensus.BitcoinPostforkTime = 1516413885;
            consensus.powLimit = uint256S("0007ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
            consensus.powLimitStart = uint256S("0000000fffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
            consensus.powLimitLegacy = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
            consensus.CharityPubKey = "9bdb39cb8fa89a39f8e292ac70213f0bf4817d4f"; // 1FD6MonoaHV8FhHpphrcDWE9oKXoVc2CFp
            consensus.PreminedPubKey = "9bdb39cb8fa89a39f8e292ac70213f0bf4817d4f"; // 1FD6MonoaHV8FhHpphrcDWE9oKXoVc2CFp
            //based on https://github.com/BTCIPU/BTCIPU/issues/78
            ...
            nDefaultPort = 8331; // different port than Bitcoin
...
public:
    CTestNetParams() {
            ...
            consensus.BCIHeight = 1258854;
            consensus.BCIPremineWindow = 50;
            ...
            consensus.powLimitStart = uint256S("0000000fffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
            consensus.powLimitLegacy = uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
            consensus.CharityPubKey = "1c1b54c6d291e03b8370bb4cafd14d1498b009b9"; // 18jKhrn9XRWT2hQmLZnNPaaTAe1b2H2QE9
            consensus.PreminedPubKey = "d789789cc3d545aa11b7c5886226e35e0b66cc99"; // 18jKhrn9XRWT2hQmLZnNPaaTAe1b2H2QE9
            //based on https://github.com/BTCIPU/BTCIPU/issues/78
            consensus.nPowAveragingWindow = 30;
            assert(maxUint/UintToArith256(consensus.powLimit) >= consensus.nPowAveragingWindow);
            consensus.nPowMaxAdjustDown = 32;
            ...
            vSeeds.emplace_back("test-seeder1.bci-server.com", true);
            vSeeds.emplace_back("test-seeder2.bci-server.com", true);
            vSeeds.emplace_back("test-seeder3.bci-server.com", true);
            vSeeds.emplace_back("test-seeder4.bci-server.com", true);
...
public:
    CRegTestParams() {
            ...
            consensus.BCIHeight = 300;
            consensus.BCIPremineWindow = 10;
            consensus.BCIPremineEnforceWhitelist = false;
            ...
            consensus.CharityPubKey = "54c9f6ee35967ccba9bd604ab2b1574266ce5b88"; // 18jKhrn9XRWT2hQmLZnNPaaTAe1b2H2QE9
            consensus.PreminedPubKey = "54c9f6ee35967ccba9bd604ab2b1574266ce5b88"; // 18jKhrn9XRWT2hQmLZnNPaaTAe1b2H2QE9
            //based on https://github.com/BTCIPU/BTCIPU/issues/78
            consensus.nPowAveragingWindow = 30;
