...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Interest developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Interest"
...
#define PACKAGE_NAME "Bitcoin Interest"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoin Interest 0.15.0"
